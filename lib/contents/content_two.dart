...
class Content2 extends StatefulWidget {
  ...
  @override
  State<Content2> createState() => _ContentState();
}

class _ContentState extends State<Content2> {
  Future<String> _loadFileContents() async {
    String contents = await rootBundle.loadString('assets/files/bb.txt');
    return contents;
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: FutureBuilder(
                future: rootBundle.loadString('assets/files/bb.txt'),
                builder:
